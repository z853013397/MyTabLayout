 ...
 * 主页的present
 */
public class ForumNumPresenter {
    private GetDataBiz biz;
    private ViewDataListener mainFragmentView;


    public ForumNumPresenter(ViewDataListener mainFragmentView) {
        biz = new GetDataBiz();
    ...
    public void getData() {
        ...
        biz.getData(mainFragmentView.getParamInfo(0), Contants.GET_MY_FROUM_NUM, new OkHttpClientManager.ResultCallback<ForumListBean>() {
            @Override
