        ...
        gridview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    startActivity(new Intent(SelectPictureActivity.this, ShowPhotoActivity.class).putExtra("list", (Serializable) (currentImageFolder.images)).putExtra("position", position-1));
                }
            }
        });
